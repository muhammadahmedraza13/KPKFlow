...
namespace KPKflowApi.Models.PurchaseRequest
{
    ...
    public class RFQQuotationModel
    {
        public string? QuotedPrice { get; set; }

        public List<RFQQuotationDetailModel>? Details { get; set; }
    }

    public class RFQQuotationDetailModel
    {
